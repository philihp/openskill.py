...
class ThurstoneMostellerFullRating:
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, ThurstoneMostellerFullRating):
...
class ThurstoneMostellerFullTeamRating:
    ...
    def __init__(
        ...
        :param rank: The rank of the team within a game.
        """
        self.mu = float(mu)
    ...
    def __eq__(self, other: Any) -> bool:
        if not isinstance(other, ThurstoneMostellerFullTeamRating):
            return NotImplemented
...
class ThurstoneMostellerFull:
    ...
    def _check_teams(teams: list[list[ThurstoneMostellerFullRating]]) -> None:
        ...
        for team in teams:
            ...
            for player in team:
                if not isinstance(player, ThurstoneMostellerFullRating):
                    raise TypeError(
                        f"Argument 'teams' must be a list of lists of 'ThurstoneMostellerFullRating' objects, "
